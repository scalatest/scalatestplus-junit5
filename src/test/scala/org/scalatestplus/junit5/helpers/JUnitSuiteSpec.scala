...
import org.scalatestplus.junit5.helpers._
...
class JUnitSuiteSpec extends funspec.AnyFunSpec {
  ...
  describe("A JUnitSuite") {
    ...
    it("should return a tags map from the tags method that contains only methods marked with org.junit.Disabled") {
    ...
    it("should return the correct test count from its expectedTestCount method") {
      ...
      val c = new org.scalatestplus.junit5.helpers.CSuite
      assert(c.expectedTestCount(Filter(Some(Set("org.scalatestplus.junit.FastAsLight")), Set())) === 0)
      assert(c.expectedTestCount(Filter(None, Set("org.scalatestplus.junit.FastAsLight"))) === 1)
